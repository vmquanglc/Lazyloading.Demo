...
namespace Lazyloading.Demo.Migrations
{
    ...
    [Migration("20251008023924_CreateTodoTask")]
    partial class CreateTodoTask
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lazyloading.Demo.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Lazyloading.Demo.TodoTasks.ChecklistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppChecklistItems", (string)null);
                });

            modelBuilder.Entity("Lazyloading.Demo.TodoTasks.TodoTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Lazyloading.Demo.TodoTasks.UploadFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppUploadFiles", (string)null);
                });
            ...
            modelBuilder.Entity("Lazyloading.Demo.TodoTasks.ChecklistItem", b =>
                {
                    b.HasOne("Lazyloading.Demo.TodoTasks.TodoTask", "TodoTask")
